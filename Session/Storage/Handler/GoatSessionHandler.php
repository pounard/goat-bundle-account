...
namespace Goat\AccountBundle\Session\Storage\Handler;

use Goat\AccountBundle\AccountModelAware;

class GoatSessionHandler implements \SessionHandlerInterface
{
